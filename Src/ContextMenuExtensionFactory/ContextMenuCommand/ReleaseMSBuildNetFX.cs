...
{
    public class ReleaseMSBuildNetFX : IContextMenuCommand
    {
        #region IContextMenuCommand 成员

        string IContextMenuCommand.Name
        {
            get { return "编译.NET项目Release模式(.sln)(&B)"; }
        }
        ...
        private static void ConstructFileArguments(string rootPath, string searchPattern)
        {
            ...
            string temp = null;
            string netFX2MSBuild = @" /Q /C %windir%\Microsoft.NET\Framework\v2.0.50727\MSBuild.exe #File /t:Build /p:Configuration=Release ";
            string netFX3MSBuild = @" /Q /C  %windir%\Microsoft.NET\Framework\v3.5\MSBuild.exe #File /t:Build /p:Configuration=Release ";
            string netFX4MSBuild = @" /Q /C %windir%\Microsoft.NET\Framework\v4.0.30319\MSBuild.exe #File /t:Build /p:Configuration=Release ";
