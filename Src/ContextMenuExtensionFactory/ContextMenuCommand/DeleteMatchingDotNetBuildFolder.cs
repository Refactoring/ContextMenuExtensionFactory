...
{
    public class DeleteMatchingDotNetBuildFolder : IContextMenuCommand
    {
        ...
        {
            get { return "删除.NET编译目录(bin,obj)(&N)"; }
        }

        string IContextMenuCommand.Description
        {
            get { return "删除此目录下的所有bin,obj文件目录及子目录"; }
        }
        ...
        {
            DeleteMatchingFolder(parameter, "obj");
            DeleteMatchingFolder(parameter, "bin");
        }
